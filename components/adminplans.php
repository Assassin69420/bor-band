		...
		<div class="panel">
			<div class="aside">
				...
				<div class="list">
					...
					<div class="item selected"><a href="adminplans.php">PLANS</a></div>
			...
			<div class="view">
				...
				<form action="" method="post" class="seprate">
					...
					<input name="speed">
					<label for="fup_limit">Fup Limit</label>
					<input name="fup_limit">
					<label for="min_bill_period">Min First Bill Period</label>
					<select name="min_bill_period">
